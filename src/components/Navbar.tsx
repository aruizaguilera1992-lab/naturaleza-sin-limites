      ...
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a href="tel:+34600000000" className="flex items-center gap-2 text-foreground/80 hover:text-primary transition-colors">
                ...
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <a
                      ...
                      className="block py-2 text-foreground/80 hover:text-primary transition-colors font-medium uppercase tracking-wider"
                    >
                      {link.label}
                    </a>
                  </li>
