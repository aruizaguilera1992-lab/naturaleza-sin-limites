...
const plans = [
  ...
  },
  {
    ...
    components: [
      { icon: Dumbbell, text: '2 sesiones presenciales por semana (8 al mes) para entrenar contigo y corregir la técnica en directo' },
      { icon: Video, text: '2 sesiones online 1-a-1 al mes por Zoom para resolver dudas, ajustar el plan y mantener la motivación alta' },
      { icon: MessageCircle, text: 'Acceso ilimitado a comunidad privada y biblioteca online para apoyo constante y recursos extra' },
      { icon: Activity, text: 'Plan de entrenamiento personalizado actualizado cada mes, adaptado a tu progreso y agenda' },
      { icon: Apple, text: 'Plan nutricional personalizado con revisión mensual' },
      { icon: Video, text: 'Análisis de movimiento en vídeo (2 al mes) para mejorar rendimiento y prevenir lesiones' },
    ],
    pricingOptions: [
      { sessions: 'Plan completo', total: '8 presenciales + 2 online', price: '329€/mes', note: 'Todo incluido para resultados visibles' },
      { sessions: '6 meses prepago', total: 'Ahorro 15%', price: '285€/mes', note: 'Ideal si ya tienes claro que quieres un cambio serio' },
    ],
    commitment: '3 meses mínimo',
    commitmentNote: 'para garantizar resultados y un proceso bien estructurado',
    discount: '15% con 6 meses prepago',
    benefits: [
      'Sistema completo: entrenamiento + técnica + nutrición en uno',
      'Seguimiento continuo sin coordinar varios profesionales',
      'Plan 100% adaptado a tus objetivos y agenda',
      'Análisis de video para corrección técnica y prevención de lesiones',
      'Motivación alta con sesiones online personalizadas',
    ],
    solves: [
      'Falta de tiempo para gestionar múltiples servicios y coaches',
      'Miedo a lesiones por falta de asesoramiento especializado',
      'Coste elevado de contratar varios profesionales por separado',
      'Falta de feedback claro y continuo sobre tu progreso',
    ],
  },
  {
    ...
    components: [
      { icon: Mountain, text: 'Actividades outdoor con 3 niveles de dificultad (iniciación, intermedio y avanzado) para que siempre encuentres un reto a tu medida' },
      { icon: Users, text: 'Grupos reducidos con guía especializado en deportes de aventura' },
      { icon: Activity, text: 'Material técnico incluido, sin necesidad de comprar equipo específico para empezar' },
    ],
    pricingOptions: [
      { sessions: 'Actividad suelta', total: 'Según nivel y tipo', price: '59-79€', note: 'Perfecto para probar sin compromiso' },
      { sessions: 'Paquete 4 actividades', total: 'Ahorro 10%', price: '215€', note: 'Un mes lleno de aventuras' },
      { sessions: 'Paquete 8 actividades', total: 'Ahorro 15%', price: '380€', note: 'Ideal para comprometerte con tu progreso outdoor' },
    ],
    commitment: 'Sin suscripción',
    commitmentNote: 'pagas solo por las salidas que realizas',
    discount: 'Hasta 15% en paquetes',
    benefits: [
      'Salidas guiadas cada fin de semana con seguridad garantizada',
      '3 niveles de dificultad para encontrar tu reto perfecto',
      'Aplica lo que entrenas en un entorno real de montaña',
      'Flexibilidad total: sin cuotas, sin compromiso mensual',
    ],
    solves: [
      'Falta de equipo técnico para empezar actividades de aventura',
      'Dificultad para encontrar compañeros y organizar salidas',
      'Inseguridad para practicar deportes de montaña sin guía experto',
    ],
  },
];
