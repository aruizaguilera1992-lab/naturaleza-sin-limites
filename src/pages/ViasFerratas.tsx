        ...
        <div className="container mx-auto px-4 relative z-10 text-center pt-24">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold text-white mb-6">
              Vías Ferratas:{' '}
              <span className="text-gradient">Adrenalina en las Alturas</span>
            </h1>
            
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-6">
              Vive la emoción de la pared vertical con total seguridad. 
              Puentes tibetanos, tirolinas y paisajes espectaculares te esperan.
            </p>

            <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/20 backdrop-blur-sm rounded-full border border-green-500/30 mb-10">
              <ShieldCheck className="h-5 w-5 text-green-400" />
              <span className="text-green-400 font-medium">Actividad apta para principiantes con equipo de seguridad</span>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
              ...
              la vía ferrata perfecta para ti.
            </p>
            <a
